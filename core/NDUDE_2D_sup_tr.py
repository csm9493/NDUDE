...
class Train_NDUDE_2D:
    ...
    def __init__(self, case = None, delta=0.05, mini_batch_size=256, k = 3, ep=10):
        ...
        self.epochs = ep
        self.training_data_file_name = 'NDUDE_sup_training_data_k'+str(k)+'_delta'+str(int(self.delta*100))+'.hdf5'
        self.save_file_name = 'NDUDE_2D_sup_training_data_k'+str(k)+'_delta'+str(int(self.delta*100))
        self.k = k
        self.nb_classes = 2
